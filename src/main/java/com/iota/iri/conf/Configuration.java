...
public class Configuration {
    ...
    public enum DefaultConfSettings {
        ...
        DB_CONN_POOL_PROP, // use for innodb
        LOAD, // 从Rdb全新加载数据
        SEND_LIMIT,
        MAX_PEERS,
...
// 新增的两个
        conf.put(DefaultConfSettings.MAIN_DB.name(), "innodb");
        conf.put(DefaultConfSettings.DB_CONN_POOL_PROP.name(), "mybatis-config.xml");
        ...
        // 源码为false 为了实现transactionLive 功能, 这里要设置成true
        conf.put(DefaultConfSettings.ZMQ_ENABLED.name(), "true");
