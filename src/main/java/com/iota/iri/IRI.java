...
import com.iota.iri.dataAnalysis.RodbDataFishingRunner;
import com.iota.iri.dataAnalysis.TransactionAnalysisRunner;
...
import static com.iota.iri.dataAnalysis.RodbDataFishingRunner.synced;
...
public class IRI {
    ...
    public static void validateParams(final Configuration configuration, final String[] args) throws IOException {
        ...
        final Option<Boolean> load = parser.addBooleanOption("load");
        ...
        if (parser.getOptionValue(load) != null) {
            log.info("Load all data from Rocksdb");
            configuration.put(DefaultConfSettings.LOAD, "true");
        }
