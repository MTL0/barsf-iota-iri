...
import com.iota.iri.storage.innoDB.InnoDBPersistenceProvider;
...
public class Iota {
    ...
    private void initializeTangle() {
        ...
        switch (configuration.string(Configuration.DefaultConfSettings.MAIN_DB)) {
            case "innodb": {
                tangle.addPersistenceProvider(new InnoDBPersistenceProvider(
                        configuration.string(Configuration.DefaultConfSettings.DB_CONN_POOL_PROP)
                ));
                break;
            }
            default: {
